    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card-body d-flex justify-content-end">
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_boardpage') }}">
                    Add
                </a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/add_board') }} method='post'>
                                @csrf
                ...
                <div class="container-fluid">
                    <div class="card">
                                                ...
                                                <div class="modal fade" id="editModal{{ $data->id }}" tabindex="-1"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action={{ url('admin/update_board') . '/' . $data->id }}
                        ...
                        <a class="btn btn-danger btn-sm deleteBtn"
                            href="{{ url('admin/show_board/delete/') . '/' . $data->id }}"
