...
<head>
    <title>Question Bank | Manage School</title>
    @include('Admin/head')
    <style>
        tfoot input {
            width: 100%;
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card-body d-flex justify-content-end">
                <a type="button" href="{{ url('admin/add_schoolpage') }}" class="btn btn-primary">
                    Add
                </a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/add_school') }} enctype="multipart/form-data" method='post'>
                                @csrf
                ...
                <div class="container-fluid">
                    <div class="card">
                                                ...
                                                <div class="modal fade" id="editModal{{ $data->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action={{ url('admin/update_school') . '/' . $data->id }}
                        ...
                        <a class="btn btn-danger btn-sm deleteBtn"
                            href="{{ url('admin/show_school/delete/') . '/' . $data->id }}"
