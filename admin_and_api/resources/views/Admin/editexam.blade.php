    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <form action={{ url('admin/update_exam') . '/' . $result->id }} enctype="multipart/form-data"
                            method='post'>
                            ...
                            <div class="row">
                                ...
                                {{-- <div class="col-md-6">
                                    <div class="col-md-12 col-lg-12">
                                        <label>Subject</label>
                                        <div class="form-group">
                                            <select class="form-control multiple-select" name="subject" id="subject"
                                                class="selectpicker" multiple></select>
                                            <option value="{{ $result->id }}" selected>
                                                {{ $result->subject_name }}</option>
