    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card-body d-flex justify-content-end">
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_exam_subjects') }}">
                    +
                </a>
                &nbsp;&nbsp;
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_exampage') }}">
                    Add
                </a>
            </div>
            {{-- <div class="card-body d-flex justify-content-end">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/add_exam') }} method='post'>
                                @csrf
                                <div class="col-md-12 col-lg-12">
                                    <label>Exam Name</label>
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="exam_name" placeholder="Enter The Exam Name">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($data->status == 'Active')
                                                    <form action={{ url('admin/status_change_exam') . '/' . $data->id }}
                                                        method="post">
                                            ...
                                            {{-- <td><button type="button" class="btn btn-primary btn-sm"
                                                ...
                                                <div class="modal fade" id="editModal{{ $data->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action={{ url('admin/update_exam') . '/' . $data->id }}
                                                ...
                                                <a type="button" class="btn btn-primary btn-sm"
                                                    href="{{ url('admin/update_exam/edit/' . $data->id) }}"
                                                    name="update"><i class="fa fa-edit"></i></a>
                                                <a class="btn btn-danger btn-sm deleteBtn"
                                                    href="{{ url('admin/show_exam/delete/') . '/' . $data->id }}"
