...
<head>
    <title>Question Bank | Manage Country</title>
    @include('Admin/head')
    <style>
        tfoot input {
            width: 100%;
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card-body d-flex justify-content-end">
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_countrypage') }}">
                    Add
                </a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/add_country') }} enctype="multipart/form-data" method='post'>
                                @csrf
                                <div class="col-md-12 col-lg-12">
                                    <label>Add Country Name</label>
                                    <div class="form-group">
                                        <select class="form-control" name="country_name">
                                            <option value="" style="display: none" selected>Select Country
                                            </option>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="overflow-x:scroll">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @php $a=1; @endphp
                                    @foreach ($selected_country as $data)
                                        <tr>
                                            <td>{{ $a++ }}</td>
                                            <td>{{ $data->country_name }}</td>
                                            <td><a class="btn btn-danger btn-sm deleteBtn"
                                                    href="{{ url('admin/show_country/delete/') . '/' . $data->id }}"
