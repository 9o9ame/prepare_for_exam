                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/save_testimonial') }} method='post'>
                                @csrf
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <div class="modal fade" id="editModal{{ $data->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action={{ url('admin/update_testimonial') }}
                                                                    method='post'>
                                                ...
                                                <a class="btn btn-danger btn-sm deleteBtn"
                                                    href="{{ url('admin/show_testimonial/delete/') . '/' . $data->id }}"
                                                    onclick="return confirm('Do you want to delete Y/N')"><i
