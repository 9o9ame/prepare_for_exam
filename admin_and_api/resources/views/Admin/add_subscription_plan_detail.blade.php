        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Add Subcription Plan Details</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Home</a></li>
                                <li class="breadcrumb-item active">Add Subcription Plan Details</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        <form action={{ url('admin/add_subscription_plan') }} enctype="multipart/form-data"
                            method='post'>
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="plan_for">
                                                <option value="" style="display: none">Select Subscription For
                                                </option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="subscription_type">
                                                <option value="" style="display: none">Select Subscription Plan Type
                                                </option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="sv_month">
                                                <option value="" style="display: none">Subscription Validity ( Month )
                                                </option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="country" id="country_name">
                                                <option value="" style="display: none">Select Country
                                                </option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="no_of_board">
                                                <option value="" style="display: none">Select Board
                                                </option>
