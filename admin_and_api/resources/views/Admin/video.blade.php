...
<head>
    <title>Optlnn | Manage Videos</title>
    @include('Admin/head')
    <style>
        tfoot input {
            width: 100%;
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/save_video') }} enctype="multipart/form-data" method='post'>
                                @csrf
                                ...
                                <tbody>
                                    ...
                                    @foreach ($video as $data)
                                        <tr>
                                            ...
                                            <td><a href="{{ $data->video_url }}" target="_blank">Link</a></td>

                                            <td><a href="{{ url($data->video) }}" width="1920px" height="1080px"
                                                    controls>video</a></td>
                                            <td><button type="button" class="btn btn-primary btn-sm"
                                                ...
                                                <div class="modal fade" id="editModal{{ $data->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action={{ url('admin/update_video') . '/' . $data->id }}
                                                ...
                                                <a class="btn btn-danger btn-sm deleteBtn"
                                                    href="{{ url('admin/show_video/delete/') . '/' . $data->id }}"
