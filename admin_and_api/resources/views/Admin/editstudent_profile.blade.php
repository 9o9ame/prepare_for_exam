            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        ...
                        @endif
                        <form action={{ url('admin/update_student_profile') . '/' . $result->id }}
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="country_name" id="country_name">
                                                <option value="{{ $result->country_name }}" style="display: none">
                                                    {{ $result->country_name }}</option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="country_code" id="country_code">
                                                <option value="{{ $result->country_code }}">
                                                    {{ $result->country_code }}</option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <input type="number" class="form-control" name="contact"
                                                placeholder="Enter Your Contact Number" value="{{ $result->contact }}">
                                            <span class="text-danger">
                                                @error('contact')
                                                    {{ $message }}
                                                @enderror
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="school">
                                                <option value="{{ $result->school }}" style="display: none">
                                                    {{ $result->school }}</option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="board">
                                                <option value="{{ $result->board }}" style="display: none">
                                                    {{ $result->board }}
                                                </option>
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="exam">
                                                <option value="{{ $result->exam }}" style="display: none">
                                                    {{ $result->exam }}
                                                </option>
