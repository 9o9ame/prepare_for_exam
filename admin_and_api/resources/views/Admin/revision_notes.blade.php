...
<head>
    <title>Question Bank | Manage Revision Notes</title>
    @include('Admin/head')
    <style>
        tfoot input {
            width: 100%;
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Manage Revision Notes</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Home</a></li>
                                <li class="breadcrumb-item active">Manage Revision Notes</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <div class="card-body d-flex justify-content-end">
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_revision_notespage') }}">
                    Add
                </a>
            </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="overflow-x:scroll">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @php $a=1; @endphp
                                    @foreach ($revision_notes as $data)
                                        <tr>
                                            <td>{{ $a++ }}</td>
                                            ...
                                            <td>
                                                <a type="button" class="btn btn-primary btn-sm"
                                                    href="{{ url('admin/update_revision_notes/edit/' . $data->id) }}"
                                                    name="update"><i class="fa fa-edit"></i></a>

                                                <a class="btn btn-danger btn-sm deleteBtn"
                                                    href="{{ url('admin/show_revision_notes/delete/') . '/' . $data->id }}"
