...
<head>
    <title>MoneyKart | Admin Email</title>
    @include('Admin/head')
    <style>
        tfoot input {
            width: 100%;
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title">Add Admin Email</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action={{url('admin/save_adminemail')}} method='post'>
                                @csrf
                    ...
                    <div class="card">
                        ...
                        <div class="card-body" style="overflow-x:scroll">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tbody>
                                    @foreach($adminemail as $data)
                                    <tr>
                                        <td>{{$data->id}}</td>
                                        <td>{{$data->name}}</td>
                                        <td>{{$data->email}}</td>
                                        <td>
                                            <a class="btn btn-danger btn-sm deleteBtn" href="{{url('admin/adminemail/delete/') . '/' .$data->id}}"><i class="fa fa-trash"></i></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
