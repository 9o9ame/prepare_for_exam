...
<head>
    <title>Question Bank | Manage Subject</title>
    @include('Admin/head')
    <style>
        tfoot input {
            width: 100%;
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="card-body d-flex justify-content-end">
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_exam_subjects_board') }}">
                    +
                </a>
                &nbsp;&nbsp;
                <a type="button" class="btn btn-primary" href="{{ url('admin/add_subjectpage') }}">
                    Add
                </a>
            </div>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action={{ url('admin/add_subject') }} enctype="multipart/form-data" method='post'>
                                @csrf
                ...
                <div class="container-fluid">
                    <div class="card">
                                                ...
                                                <div class="modal fade" id="editModal{{ $data->id }}"
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <form
                                                                    action={{ url('admin/update_subject') . '/' . $data->id }}
                        ...
                        <a class="btn btn-danger btn-sm deleteBtn"
                            href="{{ url('admin/show_subject/delete/') . '/' . $data->id }}"
