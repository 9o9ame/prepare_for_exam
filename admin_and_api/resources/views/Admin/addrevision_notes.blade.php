        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1>Add Revision Note</h1>
                        </div>
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{ url('admin/dashboard') }}">Home</a></li>
                                <li class="breadcrumb-item active">Add Revision Note</li>
                            </ol>
                        </div>
                    </div>
                </div><!-- /.container-fluid -->
            ...
            <section class="content">
                <div class="container-fluid">
                    <div class="card">
                        ...
                        @endif
                        <form action={{ url('admin/add_revision_notes') }} enctype="multipart/form-data" method='post'>
                            @csrf
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <div class="col-md-12 col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control" name="sub_topic">
                                                <option value="" style="display: none">Select Sub-Topic</option>
