...
crossorigin="anonymous"></script>
<script src="{{('app-assets/vendors/js/app-menu.min.js')}}"></script>
<script src="{{('app-assets/vendors/js/app.min.js')}}"></script> --}}
...
integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy"
crossorigin="anonymous"></script>
<script src="{{asset('app-assets/vendors/js/app-menu.min.js')}}"></script>
<script src="{{asset('app-assets/vendors/js/app.min.js')}}"></script> --}}
